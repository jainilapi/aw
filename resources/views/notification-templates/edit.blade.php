    ...
    <div class="col-md-10 offset-md-1">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="notificationTemplateForm"
                      method="POST"
                      action="{{ route('notification-templates.update', $template) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="channel" id="channel"
                                            ...
                                            @foreach($channels as $key => $label)
                                                <option value="{{ $key }}"
                                                    {{ old('channel', $template->channel) == $key ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="body" id="body"
                                          ...
                                          rows="10" required>{{ old('body', $template->body) }}</textarea>
