    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                @if(auth()?->user()?->isAdmin() || auth()->guard('web')->user()->can('tax-slabs.create'))
                <a href="{{ route('tax-slabs.create') }}" class="btn btn-primary float-end">
                    <i class="fa fa-plus"></i> Add New Tax Slab
                </a>
                @endif
            </div>
            <div class="card-body">
